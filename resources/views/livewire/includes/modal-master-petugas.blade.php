            ...
            <div class="p-4 space-y-4 md:p-5">
                ...
                @if ($kegiatan_id && $wilayah_terkecil_type_id)
                    <div class="p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
                        role="alert">
                        <span class="font-medium">Unduh template master petugas <span wire:click='downloadMasterPetugas'
                    ...
                    <div class="pb-2 mx-auto">
                        <label for="countries"
                            class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Unggah
                            file plot petugas</label>
                        <input wire:model.live='fileImport'
                            class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                            aria-describedby="file_input_help" id="file_input" type="file">
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">Format file .xlsx
                        </p>
