...
<div wire:ignore.self id="modal-master-kegiatan" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="modal-master-kegiatan">
            ...
            <div class="flex items-center p-4 border-t border-gray-200 rounded-b md:p-5 dark:border-gray-600">
                ...
                <button wire:loading.remove wire:click="createNewKegiatan" type="button"
                ...
                <button data-modal-hide="modal-master-kegiatan" type="button"
